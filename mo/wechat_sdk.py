...
import requests
import operator
from mo.conf import CORPID, CORPSECRET, AGENTID
...
class WeChatEnterprise(object):
    ...
    def __get_access_token(self):
        access_token = models.t_sys_param.objects.get(param_key='access_token').param_value
        return access_token
    ...
    def __update_access_token(self):
        ...
        models.t_sys_param.objects.update_or_create \
            (param_key='access_token', defaults={'param_name': 'access_token', 'param_value': access_token})
        return access_token
    ...
    def __response(self, res):
        ...
        if errcode is ErrorCode.SUCCESS:
            return True, res
        # access_token 有效期为 7200秒，若无效则更新
        elif operator.eq(errcode, ErrorCode.INVALID):
    ...
    def __post(self, url, data):
        ...
        return self.__response(self, res)
